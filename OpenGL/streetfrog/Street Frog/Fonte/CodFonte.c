...
void Comentarios ()
     {
        ...
        char* p = (char*) "Diponivel em: www.thiagomedeiros.com/publico/streetfrog.zip";
        while (*p != '\0')
            {   
            glutBitmapCharacter(GLUT_BITMAP_HELVETICA_12, *p++);
            }
...
//Inicia o som
   ...
   printf("%s\n", FMOD_ErrorString(FSOUND_GetError()));
    ...
    printf ("Jogo criado por Thiago Medeiros");
    printf ("\nEsse jogo pode ser copiado e distribuido a vontade.");
    printf ("\nUtilize esse codigo para estudo.");
    printf ("\nDuvidas no codigo, envie um email para: infovirtual@gmail.com");
	...
	glutCreateWindow("Street Frog por Thiago Medeiros"); //Nome da janela
