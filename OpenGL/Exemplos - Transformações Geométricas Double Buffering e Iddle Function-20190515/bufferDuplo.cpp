...
//fun��o de desenho do c�rculo obtida em http://slabode.exofire.net/circle_draw.shtml
...
void Desenha(void)
{
   ...
   glutSwapBuffers(); //AO INV�S DE glFlush();
}
...
void Timer(int value) {
   ...
   glutTimerFunc(1, Timer, 0); // define que a fun��o Timer dever� ser executada novamente ap�s 1 segundo
}

int main(int argc, char** argv)
{
	glutInit(&argc, argv);
	glutInitDisplayMode(GLUT_DOUBLE | GLUT_RGB); //buffer duplo
	...
	glutTimerFunc(1000, Timer, 0); //define a fun��o de tempo, que come�a a executar 1000 milisegundos depois da inicializa��o
